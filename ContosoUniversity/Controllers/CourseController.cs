...
namespace ContosoUniversity.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ViewResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            ViewBag.NameSortParm = String.IsNullOrEmpty(sortOrder) ? "credit" : "";
            ...
            //ngambil Name sort parm
            if (!String.IsNullOrEmpty(searchString))
            {
                courses = courses.Where(s => s.Title.Contains(searchString));
            }

            //melakukan proses pencarian dimana nama_desc di switch dengan Title
            switch (sortOrder)
            {
                case "name_desc":
            ...
            //untuk melakukan pagination, di bagi menjadi berapa bagian 
            int pageSize = 3;
